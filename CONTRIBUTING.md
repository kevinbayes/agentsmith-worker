...
Agent Smith includes rust binaries. To work on the rust, you will need to [install rust and cargo][rustup].

## Getting Started

### Rust

First let's compile agent smith and try it out
